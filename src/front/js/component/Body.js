...
const Body = () => {
  return (
        ...
        <div className="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div className="col-md-6 pt-5 ftco-animate">
          	<div className="mt-5">
	            ...
	            <h1 className="mb-4">Estamos aqui <br/>para tu cuidado</h1>
	            <p className="mb-4">Muy, muy lejos, detrás de las montañas de palabras, lejos de los países Vokalia y Consonantia, viven los textos ciegos. Separados viven en Bookmarksgrove.</p>
	            <p><a href="#" className="btn btn-primary py-3 px-4">Haz tu cita</a></p>
            </div>
          </div>
        </div>
      </div>
    	...
    	<div className="container">
    		<div className="row d-flex">
    			<div className="col-md-6 col-lg-5 d-flex">
    				<div className="img d-flex align-self-stretch align-items-center" style="background-image:url(img/about.jpg);">
    				</div>
    			</div>
    			<div className="col-md-6 col-lg-7 pl-lg-5 py-md-5">
    				<div className="py-md-5">
			          ...
			          <div className="col-md-12 heading-section ftco-animate p-4 p-lg-5">
			            <h2 className="mb-4">Nosotros Somos <span>MediConecta</span> Una Clínica Online</h2>
			            <p>Un pequeño río llamado Duden fluye por su lugar y le proporciona la regelialia necesaria. Es un país paradisíaco, en el que fragmentos asados ​​de frases vuelan a la boca. Es un país paradisíaco, en el que fragmentos asados ​​de frases vuelan a la boca..</p>
			            <p><a href="#" className="btn btn-primary py-3 px-4">Haz tu Cita</a> <a href="#" className="btn btn-secondary py-3 px-4">Contactenos</a></p>
			          </div>
			        </div>
		        </div>
	        </div>
			        ...
			        <div className="row">
			            ...
			            <div className="media block-6 services d-flex">
			              ...
			              <div className="media-body pl-md-4">
			                ...
			                <p>Un pequeño río llamado Duden fluye por su lugar y le suministra la regelialia necesaria..</p>
			              </div>
			            </div>      
			          </div>
			          <div className="col-md-6 d-flex align-self-stretch ftco-animate">
		        		...
		        		<h3>Consulta gratis</h3>
	                      ...
	                      <select name="" id="" className="form-control">
	                        ...
	                        <option value="">Otros Servicios</option>
		    					...
		    					<div className="form-group">
			    					<input type="text" className="form-control" placeholder="Movil"/>
			    				</div>
		    				</div>
		    				<div className="">
			    				<div className="form-group">
			            		...
			            		<input type="text" className="form-control appointment_date" placeholder="Fecha"/>
		            		</div>
			    				</div>
			    				<div className="form-group">
			    					<div className="input-wrap">
			            		<div className="icon"><span className="ion-ios-clock"></span></div>
			            		<input type="text" className="form-control appointment_time" placeholder="Hora"/>
		            		</div>
			    				</div>
		    				</div>
		    				<div className="">
		    					<div className="form-group">
			              <textarea name="" id="" cols="30" rows="2" className="form-control" placeholder="Mensaje"></textarea>
			            </div>
			            <div className="form-group">
			              <input type="submit" value="Registro" className="btn btn-secondary py-3 px-4"/>
			            </div>
		    				</div>
		    			</form>
		    		</div>
    ...
    <section className="ftco-intro img" style="background-image: url(img/bg_2.jpg);">
			<div className="overlay"></div>
			<div className="container">
				<div className="row justify-content-center">
					<div className="col-md-9 text-center">
						<h2>Tu salud es nuestra prioridad</h2>
						<p>Podemos gestionar el edificio de sus sueños. Un pequeño río llamado Duden fluye por su lugar.</p>
						<p className="mb-0"><a href="#" className="btn btn-white px-4 py-3">Contáctenos</a></p>
					</div>
				</div>
			</div>
		</section>
    	...
    	<div className="container-fluid px-0">
    		<div className="row no-gutters">
    			<div className="col-md-4 d-flex">
    				<div className="img img-dept align-self-stretch" style="background-image: url(img/dept-1.jpg);"></div>
    			</div>
		...
		<section className="ftco-section" id="doctor-section">
          ...
          <div className="col-md-8 text-center heading-section ftco-animate">
            ...
            <p>Viven separados. Un pequeño río llamado Duden fluye por su lugar y le suministra la regelialia necesaria. Es un país paradisiaco.</p>
          </div>
        </div>	
				<div className="row">
					<div className="col-md-6 col-lg-3 ftco-animate">
						<div className="staff">
							<div className="img-wrap d-flex align-items-stretch">
								<div className="img align-self-stretch" style="background-image: url(img/doc-1.jpg);"></div>
							</div>
							<div className="text pt-3 text-center">
								<h3 className="mb-2">Dr. Lloyd Wilson</h3>
								<span className="position mb-2">Neurologia</span>
								<div className="faded">
									<p>Soy un adicto al trabajo ambicioso, pero aparte de eso, una persona bastante sencilla..</p>
		              ...
		              <p><a href="#" className="btn btn-primary">Agendar</a></p>
	              </div>
							</div>
						</div>
					</div>
					<div className="col-md-6 col-lg-3 ftco-animate">
						<div className="staff">
							<div className="img-wrap d-flex align-items-stretch">
								<div className="img align-self-stretch" style="background-image: url(img/doc-2.jpg);"></div>
							</div>
							<div className="text pt-3 text-center">
								<h3 className="mb-2">Dr. Rachel Parker</h3>
								<span className="position mb-2">Oftalmologia</span>
								<div className="faded">
									<p>Soy un adicto al trabajo ambicioso, pero aparte de eso, una persona bastante sencilla..</p>
									<ul className="ftco-social text-center">
		                <li className="ftco-animate"><a href="#"><span className="icon-twitter"></span></a></li>
					...
					<div className="col-md-6 col-lg-3 ftco-animate">
						<div className="staff">
							<div className="img-wrap d-flex align-items-stretch">
								<div className="img align-self-stretch" style="background-image: url(img/doc-3.jpg);"></div>
							</div>
							<div className="text pt-3 text-center">
					...
					<div className="col-md-6 col-lg-3 ftco-animate">
						<div className="staff">
							<div className="img-wrap d-flex align-items-stretch">
								<div className="img align-self-stretch" style="background-image: url(img/doc-4.jpg);"></div>
							</div>
							<div className="text pt-3 text-center">
		...
		<section className="ftco-facts img ftco-counter" style="background-image: url(img/bg_3.jpg);">
			<div className="overlay"></div>
			<div className="container">
				<div className="row d-flex align-items-center">
					<div className="col-md-5 heading-section heading-section-white">
						<span className="subheading">Hechos graciosos</span>
						<h2 className="mb-4">Más de 5.100 pacientes confían en nosotros</h2>
						<p className="mb-0"><a href="#" className="btn btn-secondary px-4 py-3">Haz tu Cita</a></p>
					</div>
		          ...
		          <div className="col-md-6 d-flex justify-content-center counter-wrap ftco-animate">
		            <div className="block-18">
		              <div className="text">
		                <strong className="number" data-number="84">0</strong>
		                <span>Numero de Doctores</span>
		              </div>
		            </div>
		          </div>
		          <div className="col-md-6 d-flex justify-content-center counter-wrap ftco-animate">
      ...
      <div className="container">
        <div className="row justify-content-center mb-5 pb-5">
          <div className="col-md-10 heading-section text-center ftco-animate">
            ...
            <p>Muy muy lejos, detrás de las montañas de la palabra, lejos de los países Vokalia y Consonantia.</p>
          </div>
        </div>
        <div className="row d-flex">
          <div className="col-md-4 ftco-animate">
            <div className="blog-entry">
              <a href="blog-single.html" className="block-20" style="background-image: url('img/image_1.jpg');">
              </a>
              <div className="text d-block">
              	<div className="meta mb-3">
                  <div><a href="#">Junio 9, 2019</a></div>
                  <div><a href="#">Admin</a></div>
                  <div><a href="#" className="meta-chat"><span className="icon-chat"></span> 3</a></div>
                </div>
                <h3 className="heading"><a href="#">Lo aterrador es que no duermes lo suficiente</a></h3>
                <p>Muy, muy lejos, detrás de las montañas de la palabra, lejos de los países Vokalia y Consonantia, viven los textos ciegos..</p>
        	...
        	<div className="col-md-4 ftco-animate">
            <div className="blog-entry">
              <a href="blog-single.html" className="block-20" style="background-image: url('img/image_2.jpg');">
              </a>
              <div className="text d-block">
              	<div className="meta mb-3">
                  <div><a href="#">Junio 9, 2019</a></div>
        	...
        	<div className="col-md-4 ftco-animate">
            <div className="blog-entry">
              <a href="blog-single.html" className="block-20" style="background-image: url('img/image_3.jpg');">
              </a>
              <div className="text d-block">
              	<div className="meta mb-3">
                  <div><a href="#">Junio 9, 2019</a></div>
        	...
        	<div className="col-md-4 ftco-animate">
            <div className="blog-entry">
              <a href="blog-single.html" className="block-20" style="background-image: url('img/image_4.jpg');">
              </a>
              <div className="text d-block">
              	<div className="meta mb-3">
                  <div><a href="#">Junio 9, 2019</a></div>
        	...
        	<div className="col-md-4 ftco-animate">
            <div className="blog-entry">
              <a href="blog-single.html" className="block-20" style="background-image: url('img/image_5.jpg');">
              </a>
              <div className="text d-block">
              	<div className="meta mb-3">
                  <div><a href="#">Junio 9, 2019</a></div>
        	...
        	<div className="col-md-4 ftco-animate">
            <div className="blog-entry">
              <a href="blog-single.html" className="block-20" style="background-image: url('img/image_6.jpg');">
              </a>
              <div className="text d-block">
              	<div className="meta mb-3">
                  <div><a href="#">Junio 9, 2019</a></div>
    ...
    <section className="ftco-section testimony-section img" style="background-image: url(img/bg_3.jpg);">
    	<div className="overlay"></div>
      <div className="container">
            ...
            <div className="carousel-testimony owl-carousel ftco-owl">
              <div className="item">
                <div className="testimony-wrap text-center py-4 pb-5">
                  <div className="user-img" style="background-image: url(img/person_1.jpg)">
                    <span className="quote d-flex align-items-center justify-content-center">
                      <i className="icon-quote-left"></i>
                    </span>
                  </div>
                  <div className="text px-4">
                    <p className="mb-4">Muy, muy lejos, detrás de las montañas de la palabra, lejos de los países Vokalia y Consonantia, viven los textos ciegos.</p>
              ...
              <div className="item">
                <div className="testimony-wrap text-center py-4 pb-5">
                  <div className="user-img" style="background-image: url(img/person_2.jpg)">
                    <span className="quote d-flex align-items-center justify-content-center">
                      <i className="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div className="item">
                <div className="testimony-wrap text-center py-4 pb-5">
                  <div className="user-img" style="background-image: url(img/person_3.jpg)">
                    <span className="quote d-flex align-items-center justify-content-center">
                      <i className="icon-quote-left"></i>
                    </span>
                  </div>
        ...
        <div className="row d-flex contact-info mb-5">
          ...
          <div className="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div className="align-self-stretch box p-4 text-center bg-light">
	            ...
	            <p><a href="tel://1234567920">66666666</a></p>
	          </div>
          </div>
          <div className="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div className="align-self-stretch box p-4 text-center bg-light">
	            ...
	            <p><a href="mailto:info@yoursite.com">info@MediConecta.com</a></p>
	          </div>
          </div>
          <div className="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div className="align-self-stretch box p-4 text-center bg-light">
        ...
        <div className="row no-gutters block-9">
          <div className="col-md-6 order-md-last d-flex">
            <form action="#" className="bg-light p-5 contact-form">
              ...
              <div className="form-group">
                <input type="text" className="form-control" placeholder="Su Email"/>
              </div>
              <div className="form-group">
              ...
              <div className="form-group">
                <input type="submit" value="Enviar Mensaje" className="btn btn-secondary py-3 px-5"/>
              </div>
            </form>
